...
def rosette_stack(fov, shape, esp, accel=1, npetals=None, bending_factor=1, osf=1.0, **kwargs):
    r"""
    ...
    traj, grad = rosette(fov[0], shape[0], esp, accel[0], npetals, bending_factor, osf, **kwargs[0])
